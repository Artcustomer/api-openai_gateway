...
use App\Form\Type\XAI\ChatCompletionCreateType;
use App\Service\XAIService;
use Artcustomer\XAIClient\Enum\Role;
...
class ChatCompletionController extends AbstractApplicationController
{
    ...
    /**
     * @Route("/create", name="application_xai_chat_completion_create", methods={"GET","POST"})
     *
    ...
    public function createChatCompletion(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $response = $this->xAIService->getApiGateway()->getChatCompletionsConnector()->create($params);
        ...
        return $this->render(
            'application/xai/chat_completion/create.html.twig',
            [
